...
#+BEGIN_SRC emacs-lisp :tangle yes
(setq own/emacs-d-dirs '("etc/" "lib/ext/" "etc/themes/")
	  own/nick ""
	  own/full-name ""
	  own/email ""
	  own/org-docs-dir '("~")
	  ...
	  own/global-set-key-prefix "C-č C-"
...
#+begin_src emacs-lisp :tangle yes
(if (file-exists-p (concat user-emacs-directory "etc/private.el.gpg"))
	(load-file (concat user-emacs-directory "etc/private.el.gpg"))
  (if (file-exists-p (concat user-emacs-directory "etc/private.el"))
	(load-file (concat user-emacs-directory "etc/private.el"))))
#+end_src
** Load packages
...
(global-set-key (kbd "s-1") 'ace-jump-char-mode)
(global-set-key (kbd "s-2") 'ace-jump-word-mode)
(global-set-key (kbd "s-3") 'ace-jump-line-mode)
(global-set-key (kbd "s-4") 'ace-jump-buffer)
(global-set-key (kbd "s-5") 'ace-window)

(global-set-key (kbd "s-8") 'ace-jump-zap-up-to-char)
(global-set-key (kbd "s-9") 'ace-jump-zap-to-char)
