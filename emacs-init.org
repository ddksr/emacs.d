...
(own/global-set-key "s-j s-c" 'ace-jump-char-mode)
(own/global-set-key "s-j s-j" 'ace-jump-word-mode)
(own/global-set-key "s-j s-l" 'ace-jump-line-mode)
(own/global-set-key "s-j s-b" 'ace-jump-buffer)
(own/global-set-key "s-j w" 'ace-window)
(own/global-set-key "s-j u" 'ace-jump-zap-up-to-char)
(own/global-set-key "s-j z" 'ace-jump-zap-to-char)
